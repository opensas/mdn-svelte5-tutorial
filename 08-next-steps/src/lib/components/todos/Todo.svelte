...
<script lang="ts">
	...
	let { todo = $bindable(), onupdate = () => {}, onremove = () => {} }: Props = $props();
	...
	function update(updatedTodo: Partial<Todo>) {
...
<div class="stack-small">
	...
	{:else}
		...
		<div class="c-cb">
			<input type="checkbox" id="todo-{todo.id}" onclick={toggle} checked={todo.completed} />
